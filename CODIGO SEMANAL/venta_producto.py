...
if precio_unitario.isdigit() == False or int(precio_unitario)<=0 or int (precio_unitario)<=100: #validara si el precio es valido y tipo numerico para que pueda continuar
...
if pregunta=="si":
    ...
    if descuento ==0  or int(descuento)<10 or int (descuento)>50 :
        print("Ha ingresado un descuento no valido...")
        exit()
    else: 
...
elif pregunta!="no": #obligamos al ususario colocar las palabras validas
    print("Debe ingresar un valor valido como (si/no)")
